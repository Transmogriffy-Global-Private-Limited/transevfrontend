  ...
  useEffect(() => {
    ...
    if (searchTerm.trim()) {
      ...
      result = result.filter(user => {
        // Safely convert each field to string for searching
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button className="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-xl text-sm font-medium transition-colors shadow-sm">
                    + Add User
                  </button>
                </div>
              </div>
              ...
              <form onSubmit={(e) => e.preventDefault()} className="flex flex-col md:flex-row gap-4">
                ...
                <div className="relative">
                  <select
                    ...
                    className="appearance-none px-4 py-2.5 pr-10 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent cursor-pointer"
                  >
                    {roles.map(role => (
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-200 rounded-xl bg-white hover:bg-gray-50 transition-colors"
                >
            ...
            {error && (
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6 text-center">
                ...
                <button onClick={fetchUserDetails} className="mt-4 text-emerald-600 hover:text-emerald-700 font-medium">
                  Try Again
                </button>
              </div>
            )}
              ...
              <>
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <table className="w-full">
                      <thead className="bg-gray-50 border-b border-gray-100">
                        <tr>
                          ...
                          <th className="px-4 md:px-6 py-4 text-right text-xs font-semibold text-gray-500 uppercase tracking-wider">
                            Actions
                          </th>
                        </tr>
                      </thead>
                        ...
                        {currentUsers.length > 0 ? (
                          currentUsers.map((user) => (
                            ...
                            >
                              ...
                              <td className="px-4 md:px-6 py-4">
                                <span className="text-sm font-mono text-gray-600">{user.user_number || 'N/A'}</span>
                              </td>
                              <td className="px-4 md:px-6 py-4">
                  ...
                  {filteredUsers.length > 0 && (
                    <div className="px-4 md:px-6 py-4 border-t border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            {showUserModal && selectedUser && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" onClick={() => setShowUserModal(false)}>
                <div className="bg-white rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                  <div className="relative">
                    <div className="h-32 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-t-2xl"></div>
                    <button
                      onClick={() => setShowUserModal(false)}
                      className="absolute top-4 right-4 bg-white rounded-full p-1.5 shadow-md hover:bg-gray-100 transition-colors"
                    >
                  ...
                  <div className="pt-16 pb-6 px-6">
                    <div className="text-center mb-6">
                      ...
                      <p className="text-sm text-gray-500 mt-1">{selectedUser.role || 'User'}</p>
                    </div>
                    <div className="space-y-4">
                      <div className="flex items-center gap-3 py-2 border-b border-gray-100">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-mono text-gray-800">{selectedUser.user_number || 'N/A'}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 py-2 border-b border-gray-100">
                        <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="flex items-center gap-3 py-2 border-b border-gray-100">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-800">{selectedUser.phone_number || 'N/A'}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3 py-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-800">{selectedUser.created_at ? new Date(selectedUser.created_at).toLocaleString() : 'N/A'}</p>
                        </div>
                      </div>
                    </div>
                    <div className="mt-6 flex gap-3">
                      <button className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-xl font-medium transition-colors">
                        Edit User
                      </button>
                      <button className="flex-1 border border-red-300 text-red-600 hover:bg-red-50 px-4 py-2 rounded-xl font-medium transition-colors">
                        Suspend
                      </button>
                    </div>
                  </div>
