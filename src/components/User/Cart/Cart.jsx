...
//                             // Get the selected payment option for the current product
//                             const paymentMethod = selectedPaymentOption[productId] || "Cash";  // Default to "Cash" if not selected
...
//                                 paymentoption: paymentMethod,  // Payment method (Cash, UPI, etc.)
...
//                                 // Directly call addorder API for Cash payment
//                                 const response = await axios.post(
//                                     `${BASE_URL_AND_PORT}/order/addorder`,
//                                     orderPayload,  // Send the payload for the specific product
//                                     {
//                                         headers: {
//                                             'API-KEY': API_KEY,
//                                         },
...
//                                 // Handle the response for Cash payment
//                                 if (response.data) {
...
//                                 }
//                             } else {
//                                 // For Razorpay payment (UPI or Card), proceed with Razorpay payment flow
