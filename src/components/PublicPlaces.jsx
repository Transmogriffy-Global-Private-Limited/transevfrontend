...
const Hotels = () => {
  ...
  <button className="relative inline-flex items-center justify-center px-10 py-4 bg-yellow-300 text-white font-semibold rounded-full group transition-all duration-300 ease-in-out mt-20 mr-220">
  ...
  <a href="#explore" className="text-2xl font-semibold text-black-500 hover:underline inline-flex items-center">
    ...
    <section className="flex py-20 px-8 mt-30">
      ...
      <div className="w-1/2 pr-10">
        ...
        <p className="text-xl font-semibold text-gray-700 mb-1 ml-10">
  <a
  ...
  <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center gap-10">
    ...
    <div className="lg:w-1/2 text-center lg:text-left">
      <h2 className="text-xl font-semibold mb-4 w-1000 mr-40">
        Take a look at the products we can <br /> install at  your hotel for charging
      </h2>
    </div>
